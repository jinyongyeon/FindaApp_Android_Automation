...
class JoinTestCase(unittest.TestCase):
    ...
    def test_message_certification(self):
        ...
        try:
            ...
            logging.error(f"MO인증 테스트 테스트 진행 중 에러 발생 : {e}")
    ...
    def test_enter_personal_information(self):
        ...
        try:
            ...
            try:
                ...
                logging.info("유심내용 자동입력 결과 : FAIL")
            ...
            logging.error(f"유심내용 자동입력 테스트 진행중 에러 발생 : {e}")
    ...
    def test_membership_terms_and_conditions(self):
        ...
        try:
            ...
            try:
                ...
                results.append("FAIL")
                logging.info("회원가입 약관 진입_aa : FAIL")
            ...
            try:
                ...
                results.append("FAIL")
                logging.info("회원가입 약관 진입_ab : FAIL")
            ...
            try:
                ...
                results.append("FAIL")
                logging.info("회원가입 약관 진입_ac : FAIL")
            ...
            try:
                ...
                results.append("FAIL")
                logging.info("회원가입 약관 진입_ba : FAIL")
            ...
            try:
                ...
                results.append("FAIL")
                logging.info("회원가입 약관 진입_bb : FAIL")
            ...
            try:
                ...
                results.append("FAIL")
                logging.info("회원가입 약관 진입_bc : FAIL")
            ...
            try:
                ...
                results.append("FAIL")
                logging.info("회원가입 약관 진입_ca : FAIL")
            ...
            try:
                ...
                results.append("FAIL")
                logging.info("회원가입 약관 진입_cb : FAIL")
            ...
            try:
                ...
                results.append("FAIL")
                logging.info("회원가입 약관 진입_cc : FAIL")
            ...
            try:
                ...
                results.append("FAIL")
                logging.info("회원가입 약관 진입_cd : FAIL")
            ...
            try:
                ...
                results.append("FAIL")
                logging.info("회원가입 약관 진입_ce : FAIL")
            ...
            try:
                ...
                logging.info("회원가입 약관 노출_4 : FAIL")
                results.append("FAIL")
            ...
            try:
                ...
                results.append("FAIL")
                logging.info("회원가입 약관 진입_da : FAIL")
            ...
            logging.error(f"회원가입 약관 동의 진입 테스트 진행 중 에러 발생 : {e}")
    ...
    def test_certification_number(self):
        ...
        try:
            ...
            try:
                ...
                logging.info("회원가입 인증번호 자동입력 결과 : FAIL")
            ...
            try:
                ...
                logging.info("회원가입 인증번호 재요청 : FAIL")
            ...
            logging.error(f"인증번호 수신 및 자동입력, 재요청 테스트 진행 중 에러 발생 : {e}")
    ...
    def test_join(self):
        ...
        try:
            ...
            logging.error(f"핀코드 등록 및 회원가입 테스트 진행 중 에러 발생 : {e}")
...
class LoginTestCase(unittest.TestCase):
    ...
    def test_check_in(self):
        ...
        try:
            ...
            logging.error(f"핀코드 로그인 테스트 진행 중 에러 발생 : {e}")
    ...
    def test_log_out(self):
        ...
        try:
            ...
            logging.error(f"로그아웃 테스트 진행 중 에러 발생 : {e}")
    ...
    def test_withdraw(self):
        ...
        try:
            ...
            logging.error(f"회원탈퇴 테스트 진행 중 에러 발생 : {e}")
        logging.info("회원탈퇴 테스트 시작")
