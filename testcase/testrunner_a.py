...
class test:
    ...
    def testmore(self):
        ...
        suite.addTest(MoreTestcase_C('test_point'))
        suite.addTest(MoreTestcase_C('test_checkin'))
        suite.addTest(MoreTestcase_C('test_price_forecast_season_1'))
        suite.addTest(MoreTestcase_C('test_priceforecast_history'))
