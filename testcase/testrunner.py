...
suite.addTest(Loan_Comparison_Testcase('test_Check_Deposit_Today'))
suite.addTest(Loan_Comparison_Testcase('test_Comparison_Loan_Detail'))
suite.addTest(Loan_Comparison_Testcase('test_Comparison_Loan_Detail_Certification'))
suite.addTest(Loan_Comparison_Testcase('test_Loan_Application'))
