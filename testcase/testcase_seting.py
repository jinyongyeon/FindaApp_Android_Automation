...
class Seting_Testcase(unittest.TestCase):
    ...
    def test_my_info(self):
        ...
        if all(result == "PASS" for result in results):
            print("설정 > 내 정보 진입 결과 : PASS")
            setingresult.reports.append("설정 > 내 정보 진입 결과 : *PASS*")
        else:
            print("설정 > 내 정보 진입 결과 : FAIL")
    ...
    def test_change_password(self):
        ...
        try:
            ...
            print("설정 > 비밀번호 변경_a 에러 발생 : {}".format(str(e)))
            results.append("Error")
        ...
        try:
            ...
            print("설정 > 비밀번호 변경_b 에러 발생 : {}".format(str(e)))
            results.append("Error")
        ...
        try:
            ...
            print("설정 > 비밀번호 변경_c 에러 발생 : {}".format(str(e)))
            results.append("Error")
        ...
        try:
            ...
            print("설정 > 비밀번호 변경 에러 발생 : {}".format(str(e)))
            results.append("Error")
    ...
    def test_seting_mydata(self):
        ...
        try:
            ...
            print("설정 > 금융 정보 관리(마이데이터) 진입 결과 : FAIL")
            ...
            try:
                ...
                print("설정 > 금융 정보 관리(마이데이터) 진입 에러 발생 : {}".format(str(e)))
