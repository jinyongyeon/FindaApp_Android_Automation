...
class InFo:
    ...
    name = "진용연"   # 홍길동
    rrn_a = "930709"  # 880101
    rrn_b = "1" #주민번호 뒤에 첫자리 1,2,3,4
    rrn = "017222" #주민번호 뒤에 첫자리를 제외한 6자리
    ...
    #슬랙 웹훅 결과 보고 URL
    slack_webhook_url = 'https://hooks.slack.com/services/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'
